...
namespace OrderDbFirst.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public ActionResult Index(string search)
        {
            ...
            return View(orders.Where(x => x.Product.Name.Contains(search) || search == null)
                .Where(m => m.Customer.Name.Contains(search) || search == null).ToList());
        }
        ...
        public ActionResult Create([Bind(Include = "OrderID,CustomerID,ProductID,OrderDate")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OrderID,CustomerID,ProductID,OrderDate")] Order order)
        {
            if (ModelState.IsValid)
            {
